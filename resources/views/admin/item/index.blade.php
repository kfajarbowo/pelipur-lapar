    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{route('test')}}" class="btn btn-info">Excel</a>
                        ...
                        <table id="table" class="table"  cellspacing="0" width="100%">
                         ...
                         <tbody>
                           ...
                           <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $item->name }}</td>
                            <td><img style="height: 100px; width: 100px;" class="img-responsive img-thumbnail" src="{{asset('uploads/item/'.$item->image)}}"></td>
                            ...
                            <td><a href="{{route('item.edit',$item->id)}}" class="btn btn-info btn-sm"><i class="material-icons">mode_edit</i>
                                </a>
